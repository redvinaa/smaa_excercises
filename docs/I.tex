...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, trim={20mm, 2mm, 15mm, 10mm}, clip]{ex_I_1_plots_1}
		\caption{Least-squares estimate for thin $\v{\Phi}$}
		\label{fig:ex_I_1_plots_1}
	\end{subfigure}\hfill
	\begin{subfigure}[b]{.45\textwidth}
		\centering
		\includegraphics[width=.9\textwidth, trim={20mm, 2mm, 15mm, 10mm}]{ex_I_1_plots_2}
		\caption{Recursive least-squares}
		\label{fig:ex_I_1_plots_2}
	\end{subfigure}\\
	\begin{subfigure}[b]{.45\textwidth}
		\centering
		\includegraphics[width=\textwidth, trim={20mm, 2mm, 15mm, 10mm}, clip]{ex_I_1_plots_3}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{ex_I_2_plots_1}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{ex_I_2_plots_2}
